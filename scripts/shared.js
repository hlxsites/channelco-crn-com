 ...
 */
export async function queryMatchingArticles(
  metadataName,
  value,
  limit = 10,
...
/**
 * Loads pagination for slideshow and article pages
 */
...
export async function renderContent() {
  ...
  nav.append(ul);
  const paginationBottom = nav.cloneNode(true);
  return ([nav, paginationBottom]);
}
